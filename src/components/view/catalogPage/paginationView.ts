class PaginationView {
  ...
  private createItemPagination(hrefLink: URL, page: number, active: boolean) {
  ...
  public draw(pages: number, page: number) {
    if (this.wrapperElem) {
      ...
      if (pages > 1) {
        ...
        firstItem.className = 'pagination__arrow arrow';
        ...
        lastItem.className = 'pagination__arrow arrow';
